...
namespace "ci" do
  ...
  task :xcodebuild do |t|
    run "set -o pipefail && xcodebuild test -workspace Example/OutletsExample.xcworkspace -scheme OutletsExample -sdk iphonesimulator ONLY_ACTIVE_ARCH=NO | xcpretty"
  end
